...
class PromptDialogDelegate {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        View inflate = layoutInflater.inflate(layout.hats_prompt_banner, viewGroup, false);
        updatePromptBannerText(inflate, surveyController.getPromptMessage());
        inflate.findViewById(id.hats_lib_prompt_banner).setMinimumHeight(layoutDimensions.getPromptBannerHeight(isTwoLinePrompt));
        ...
        final Button button = (Button) inflate.findViewById(id.hats_lib_prompt_no_thanks_button);
        final Button button2 = (Button) inflate.findViewById(id.hats_lib_prompt_take_survey_button);
        inflate.findViewById(id.hats_lib_prompt_no_thanks_wrapper).setOnTouchListener(new View.OnTouchListener(this) {
            public boolean onTouch(View view, MotionEvent motionEvent) {
                button.onTouchEvent(motionEvent);
                return true;
            }
        });
        inflate.findViewById(id.hats_lib_prompt_take_survey_wrapper).setOnTouchListener(new View.OnTouchListener(this) {
            public boolean onTouch(View view, MotionEvent motionEvent) {
    ...
    private void updatePromptBannerText(View view, String str) {
        AutoResizeTextView autoResizeTextView = (AutoResizeTextView) view.findViewById(id.hats_lib_prompt_title_text);
        Resources resources = context.getResources();
        LayoutUtils.fitTextInTextViewWrapIfNeeded((float) (DimensionConfigurationHelper.getPromptWidthPx(context, maxPromptWidth) - (resources.getDimensionPixelSize(dimen.hats_lib_prompt_banner_left_padding) + resources.getDimensionPixelSize(dimen.hats_lib_prompt_banner_right_padding))), 20, 16, str, autoResizeTextView);
