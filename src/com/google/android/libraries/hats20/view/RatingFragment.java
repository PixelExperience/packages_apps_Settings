...
public class RatingFragment extends BaseFragment {
    ...
    public void updateRatingQuestionTextSize(AutoResizeTextView autoResizeTextView) {
        ...
        LayoutUtils.fitTextInTextViewWrapIfNeeded(((float) size) - ((((float) (resources.getDimensionPixelSize(R.dimen.hats_lib_rating_container_padding) * 2)) + TypedValue.applyDimension(1, 24.0f, resources.getDisplayMetrics())) + TypedValue.applyDimension(1, 40.0f, resources.getDisplayMetrics())), 20, 16, question.getQuestionText(), autoResizeTextView);
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        setTextAndContentDescription((TextView) inflate.findViewById(R.id.hats_lib_survey_rating_low_value_text), question.getLowValueText());
        setTextAndContentDescription((TextView) inflate.findViewById(R.id.hats_lib_survey_rating_high_value_text), question.getHighValueText());
