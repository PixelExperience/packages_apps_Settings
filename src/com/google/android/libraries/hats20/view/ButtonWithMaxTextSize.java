...
public class ButtonWithMaxTextSize extends AppCompatButton {
    ...
    private void capTextSize(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, styleable.ButtonWithMaxTextSize);
        setTextSize(0, Math.min(getTextSize(), (float) obtainStyledAttributes.getDimensionPixelSize(styleable.ButtonWithMaxTextSize_textSizeMaxDp, Integer.MAX_VALUE)));
