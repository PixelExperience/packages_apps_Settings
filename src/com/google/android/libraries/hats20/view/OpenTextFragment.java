...
public class OpenTextFragment extends ScrollableAnswerFragment {
    ...
    View createScrollViewContents() {
        ...
        inflate.setMinimumHeight(getResources().getDimensionPixelSize(dimen.hats_lib_open_text_question_min_height));
        LinearLayout linearLayout = (LinearLayout) inflate.findViewById(id.hats_lib_survey_answers_container);
        from.inflate(layout.hats_survey_question_open_text_item, linearLayout, true);
        editTextField = (EditText) linearLayout.findViewById(id.hats_lib_survey_open_text);
        editTextField.setSingleLine(isSingleLine);
        editTextField.setHint(getResources().getString(string.hats_lib_open_text_hint));
        return linearLayout;
    }
