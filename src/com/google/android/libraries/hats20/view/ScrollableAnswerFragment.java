...
public abstract class ScrollableAnswerFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(layout.hats_survey_question_with_scrollable_content, viewGroup, false);
        questionTextView = (TextView) inflate.findViewById(id.hats_lib_survey_question_text);
        ...
        scrollView = (ScrollViewWithSizeCallback) inflate.findViewById(id.hats_survey_question_scroll_view);
        ...
        surveyControlsContainer = ((SurveyPromptActivity) viewGroup.getContext()).getSurveyContainer().findViewById(id.hats_lib_survey_controls_container);
        return inflate;
    }
    ...
    private class ScrollShadowHandler implements ViewTreeObserver.OnScrollChangedListener, ScrollViewWithSizeCallback.OnHeightChangedListener {
        ...
        private void showTopShadow() {
            setElevation(ScrollableAnswerFragment.questionTextView, (float) ScrollableAnswerFragment.getResources().getDimensionPixelSize(dimen.hats_lib_question_view_elevation));
        }
        ...
        private void showBottomShadow() {
            setElevation(ScrollableAnswerFragment.surveyControlsContainer, (float) ScrollableAnswerFragment.getResources().getDimensionPixelSize(dimen.hats_lib_survey_controls_view_elevation));
        }
