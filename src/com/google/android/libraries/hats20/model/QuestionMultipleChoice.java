...
public class QuestionMultipleChoice extends Question implements Question.QuestionWithSelectableAnswers {
    ...
    static {
        ...
        arrayMap.put(0, Integer.valueOf(drawable.hats_smiley_5));
        arrayMap.put(1, Integer.valueOf(drawable.hats_smiley_4));
        arrayMap.put(2, Integer.valueOf(drawable.hats_smiley_3));
        arrayMap.put(3, Integer.valueOf(drawable.hats_smiley_2));
        arrayMap.put(4, Integer.valueOf(drawable.hats_smiley_1));
