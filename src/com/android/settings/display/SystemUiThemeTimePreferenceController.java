...
public class SystemUiThemeTimePreferenceController extends BasePreferenceController {

    private DateFormat mTimeFormatter;
    private AutomaticThemeTimeController mAutomaticThemeTimeController;

    public SystemUiThemeTimePreferenceController(Context context, String preferenceKey) {
    ...
    public CharSequence getSummary() {
        return getFormattedTimeString(mAutomaticThemeTimeController.getCustomStartTime()) + " - " +
                    getFormattedTimeString(mAutomaticThemeTimeController.getCustomEndTime());
    }
}
