...
public class LiveDisplaySettings extends SettingsPreferenceFragment implements Indexable,
    ...
    public static final SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                public List<String> getNonIndexableKeys(Context context) {
                    ...
                    if (!hardwareManager.isSupported(LineageHardwareManager.FEATURE_SUNLIGHT_ENHANCEMENT)) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (liveDisplayPrefs != null && mOutdoorMode != null
                && !hardwareManager.isSupported(LineageHardwareManager.FEATURE_SUNLIGHT_ENHANCEMENT)) {
