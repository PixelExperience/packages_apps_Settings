...
import com.android.settings.custom.biometrics.face.SetupFaceEnrollSuggestion;
            ...
            if (requestCode != CONFIRM_REQUEST) {
                if (requestCode == ENROLL_REQUEST) {
                    if (resultCode == RESULT_FIRST_USER || resultCode == RESULT_OK) {
                        if (mFaceManager != null && mFaceManager.getEnrolledFaces(mUserId).size() > 0) {
                            SetupFaceEnrollSuggestion.disableComponent(this);
                        }
    ...
    private void openCustomFaceUnlockPackage() {
        ...
        if (mForRedo) {
            componentName = new ComponentName(
                "org.pixelexp.faceunlock",
                "org.pixelexp.faceunlock.FaceEnrollActivity");
        } else {
            componentName = new ComponentName(
                "org.pixelexp.faceunlock",
                "org.pixelexp.faceunlock.SetupFaceIntroActivity");
        }
